...
window.stk.carousel = {
    ...
    set: function (elm, targetId) {
        'use strict';
        var instance = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0___default.a(elm);
    ...
    sync: function (instance, targetId) {
        'use strict';
        var target = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0___default.a('#' + targetId);
...
window.stk.lightbox = {
    ...
    toggle: function () {
        'use strict';
        new glightbox__WEBPACK_IMPORTED_MODULE_0___default.a({
